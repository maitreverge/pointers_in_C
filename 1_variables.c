...
/*   Updated: 2024/09/10 10:37:01 by flverge          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	int		var_1;
	char	var_2;
	double	var_3; // Une variable de type double est un nombre a virgule.
	...
	// Impression des valeurs des 3 variables sur STDOUT(sortie standart).
	printf("var_1 = %i\n", var_1);
	printf("var_2 = %c\n", var_2);
	printf("var_3 = %f\n", var_3);
	...
	// Regarder sur internet la signification des `placeholders` de la fonction printf (%c, %s, %d, ect...)
}